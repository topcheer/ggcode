...
const zh: Record<TranslationKey, string> = {
  ...
  'cron.saveFailed': '保存失败：{0}',
  'cron.failedLoad': '加载失败：{0}',
  'cron.failed': '操作失败：{0}',
  'cron.edit': '编辑',
  'cron.delete': '删除',
  'cron.pause': '暂停',
  ...
  'cron.cronHint': '格式：分 时 日 月 周。例：*/5 * * * *（每5分钟）、0 9 * * 1-5（工作日9点）',
  'cron.recurring': '循环执行',
  'cron.queueIfBusy': 'Agent 忙时排队',
  'cron.editTask': '编辑任务',
  'cron.newTaskTitle': '新建任务',
  'cron.cancel': '取消',
  'cron.create': '创建',
  'cron.update': '更新',
  'cron.generateWithAI': 'AI 生成',
  'cron.aiDescription': '用自然语言描述这个任务应该做什么，AI 会帮你生成提示词。',
  'cron.aiPlaceholder': '例如：检查新的 GitHub issue 并总结',
  'cron.generate': '生成',
  'cron.generating': '生成中...',
  'cron.aiGenFailed': 'AI 生成失败：{0}',
  'cron.cronExprRequired': 'Cron 表达式不能为空',
  'cron.promptRequired': '提示词不能为空',
  'cron.descRequired': '请输入描述',
  'cron.promptPlaceholder': '任务触发时发送给 agent 的提示词...',
  'cron.nextFire': '下次触发',
  'cron.createdAt': '创建时间',
  'cron.queueLabel': '忙时排队',
  'cron.id': 'ID',
  'cron.yes': '是',
  'cron.no': '否',
  ...
  'cmd.exportMarkdown': '导出会话为 Markdown',
  'cmd.exportJSON': '导出会话为 JSON',
  'cmd.copyMarkdown': '复制会话为 Markdown',
  ...
  'kb.prevSession': '上一个会话',
  'kb.nextSession': '下一个会话',
  'kb.openSettings': '打开设置',
  'kb.globalHotkey': '全局快捷键 (显示/隐藏应用)',
  ...
  'settings.globalHotkeyHint': '使用 Option+Cmd+G 可从任何应用中显示或隐藏 GGCode（macOS）。',
  ...
  'sidebar.menuCopyMarkdown': '复制为 Markdown',
  'sidebar.menuExportMarkdown': '导出为 Markdown',
  'sidebar.menuExportJSON': '导出为 JSON',
  'sidebar.exportSaved': '会话已导出',
  'sidebar.copiedMarkdown': 'Markdown 已复制到剪贴板',
