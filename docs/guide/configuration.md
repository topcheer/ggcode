...
| `auto_title_llm` | bool | Opt-in LLM refinement of weak session titles (empty/generic after heuristic cleanup), one small side call within the first two runs. Default `false`. |
