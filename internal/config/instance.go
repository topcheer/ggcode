...
// SaveInstance saves the current config as an instance-level override.
// Only non-zero fields are written. The config is saved to
// ~/.ggcode/instances/{sha256}/ggcode.yaml.
// workspace is used to compute the instance directory.
