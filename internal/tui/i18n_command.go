...
func enCommandModule() map[string]string {
	return map[string]string{
		...
		"slash.trust_enabled":       "Workspace trusted: project skills/commands and project memory enabled (.mcp.json servers apply on next start)",
		"slash.trust_revoked":       "Workspace trust revoked: project skills/commands and project memory disabled",
...
func zhCommandModule() map[string]string {
	return map[string]string{
		...
		"slash.fork":                "分叉对话到新会话",
		"slash.trust_enabled":       "已信任工作区：项目级技能/命令与项目记忆已启用（.mcp.json 服务下次启动生效）",
		"slash.trust_revoked":       "已撤销工作区信任：项目级技能/命令与项目记忆已禁用",
