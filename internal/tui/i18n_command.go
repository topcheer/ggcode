...
func enCommandModule() map[string]string {
	return map[string]string{
		...
		"slash.adddir":              "Add an additional working directory to the file sandbox",
		...
		"slash.regenerate":          "Regenerate last response",
		"slash.branch":              "Fork conversation into new session",
		"slash.pin_session":         "Pin session (protected from cleanup)",
		"slash.unpin_session":       "Unpin session",
		"slash.tag":                 "Add tags to session",
		"slash.untag":               "Remove tags from session",
		"slash.tags":                "Show session tags",
		"slash.inspector":           "Open inspector panel",
		"slash.chat":                "Open LAN chat panel",
		"slash.nick":                "Set LAN chat identity",
		"slash.stats":               "Open session stats panel",
		"slash.tmux":                "Manage tmux session and panes",
		"slash.share":               "Share session to mobile (QR code tunnel)",
		"slash.unshare":             "Stop sharing (disconnect mobile)",
		"slash.tunnel":              "Share session to mobile (QR code tunnel)",
		"slash.retry":               "Retry last submission after error",
		"slash.edit":                "Edit and resend last submission",
		"slash.regen":               "Regenerate last response",
		"slash.fork":                "Fork conversation into new session",
		"slash.reflect":             "Show recent run reflections",
		"slash.rules":               "Manage ratchet rules",
		"slash.goal":                "Show, set, or clear persistent autopilot goal",
		...
		"command.usage.adddir":      "Usage: /add-dir <path>\n\n",
		"command.adddir.added":      "✓ %s added to allowed directories — file tools can now access it\n\n",
		"command.adddir.duplicate":  "%s is already an allowed directory\n\n",
		"command.adddir.invalid":    "Not a directory: %s\n\n",
		"command.adddir.failed":     "No active permission policy; cannot extend the sandbox\n\n",
  ...
  /edit              Edit and resend the last submission
...
func zhCommandModule() map[string]string {
	return map[string]string{
		...
		"slash.regenerate":          "重新生成最近回复",
		"slash.branch":              "分叉对话到新会话",
		"slash.pin_session":         "固定会话（免清理、列表置顶）",
		"slash.unpin_session":       "取消固定会话",
		"slash.tag":                 "为会话添加标签",
		"slash.untag":               "移除会话标签",
		"slash.tags":                "显示会话标签",
		"slash.inspector":           "打开检查器面板",
		"slash.chat":                "打开局域网聊天面板",
		"slash.nick":                "设置局域网聊天身份",
		"slash.stats":               "打开会话指标面板",
		"slash.tmux":                "管理 tmux 会话和面板",
		"slash.share":               "分享会话到手机（二维码隧道）",
		"slash.unshare":             "停止分享（断开手机）",
		"slash.tunnel":              "分享会话到手机（二维码隧道）",
		"slash.retry":               "出错后重试上次提交",
		"slash.edit":                "编辑并重新发送上次提交",
		"slash.regen":               "重新生成最近回复",
		"slash.fork":                "分叉对话到新会话",
		"slash.reflect":             "显示最近运行反思",
		"slash.rules":               "管理棘轮规则",
		"slash.goal":                "查看、设置或清除持久化自动驾驶目标",
		"command.unknown":           "未知命令：%s\n",
		"command.help_hint":         "输入 /help 查看可用命令\n\n",
		"command.usage.allow":       "用法：/allow <tool-name>\n\n",
		"command.usage.adddir":      "用法：/add-dir <path>\n\n",
		"command.adddir.added":      "✓ 已将 %s 加入允许目录，文件工具现在可以访问它\n\n",
		"command.adddir.duplicate":  "%s 已在允许目录中\n\n",
		"command.adddir.invalid":    "不是有效目录：%s\n\n",
		"command.adddir.failed":     "无活动权限策略，无法扩展沙箱\n\n",
