...
var catalogEn = map[string]string{
	...
	"daemon.keys_full":     "Press x to exit, d for background, f toggle follow, t toggle mobile share, r restart, v/q/s output, M/U mute/unmute all",
...
var catalogZhCN = map[string]string{
	...
	"daemon.keys_full":     "按 x 退出, d 后台运行, f 切换 follow, t 切换移动端分享, r 重启, v/q/s 输出模式, M/U 全部静音/取消静音",
