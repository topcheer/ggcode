...
var catalogEn = map[string]string{
	...
	"daemon.keys_full":     "Press x to exit, d for background, f toggle follow, r restart, v/q/s output mode",
...
var catalogZhCN = map[string]string{
	...
	"daemon.keys_full":     "按 x 退出, d 后台运行, f 切换 follow, r 重启, v/q/s 输出模式",
